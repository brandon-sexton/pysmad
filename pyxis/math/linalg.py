...
class Matrix3by6:
    ...
    def multiply_matrix_6by3(self, mat:"Matrix6by3") -> Matrix3D:
        return Matrix3D(
            Vector3D(self.row1.dot(mat.column_1()), self.row1.dot(mat.column_2()), self.row1.dot(mat.column_3())),
            Vector3D(self.row2.dot(mat.column_1()), self.row2.dot(mat.column_2()), self.row2.dot(mat.column_3())),
            Vector3D(self.row3.dot(mat.column_1()), self.row3.dot(mat.column_2()), self.row3.dot(mat.column_3()))
        )

class Matrix6by3:
    def __init__(self, r1:Vector3D, r2:Vector3D, r3:Vector3D, r4:Vector3D, r5:Vector3D, r6:Vector3D) -> None:
    ...
    def multiply(self, mat:Matrix3D) -> "Matrix6by3":
        return Matrix6by3(
            ...
            Vector3D(self.row2.dot(mat.column_1()), self.row2.dot(mat.column_2()), self.row2.dot(mat.column_3())),
            Vector3D(self.row3.dot(mat.column_1()), self.row3.dot(mat.column_2()), self.row3.dot(mat.column_3())),
            Vector3D(self.row4.dot(mat.column_1()), self.row4.dot(mat.column_2()), self.row4.dot(mat.column_3())),
            Vector3D(self.row5.dot(mat.column_1()), self.row5.dot(mat.column_2()), self.row5.dot(mat.column_3())),
            Vector3D(self.row6.dot(mat.column_1()), self.row6.dot(mat.column_2()), self.row6.dot(mat.column_3()))
        )
